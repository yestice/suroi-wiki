...
- Try and get your opponent to slow themselves down in some way, because it makes hitting your shots easier.
    - You can do this when your opponent is in water, shooting, or using a consumable (or any combonation).
...
- Despite having a 1x obstacle multiplier, the Barrett is still somewhat capable of destroying cover.
    ...
    - If the opponent is near a barrel or super barrel that is low on health and smoking, you can shoot it to do extra damage (though probably not as much as actually hitting them with the Barrett).
...
- By hiding in a bush and camping, you can suprise your opponents and kill them before they can react.
...
- Although the Barrett does a lot of damage, it isn't an instant kill, especially if you have high-tier armor.
- Watch out if you are at 8x or 15x range, because the Barrett has a very fast bullet velocity.
- The Barrett can be unwiedly in CQC combat due to its long barrel. Try using a high DPS weapon like a SMG or a shotgun. Weapons with short barrels like the [Flues](/weapons/guns/flues) work best for this. 
- Other powerful snipers like the [Tango 51](/weapons/guns/tango_51), while not as good as the Barrett, can still pack quite a punch against an opponent (espeically in dual form).
...
- The Barrett has the fastest bullet speed of any gun
